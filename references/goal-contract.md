...
每日节拍：[如果用户要求每天自动进化，使用 GitHub Actions cron 定时审计、artifact 和 issue handoff；不无人值守改代码或发 release]
...
- daily evolution without cron/schedule, daily audit script, GitHub Actions, issue handoff, and the rule against unattended code rewrites
